...
export class BackgroundsListComponent {
  ...
  dataSource!: MatTableDataSource<Background>;
  columnsToDisplay = ['name', 'description', 'actions'];
  expandedElement!: Background;
  ...
  constructor(
    ...
    this.backgrounds = toSignal(
      this._refresh$.pipe(
        switchMap(() => this._workshopService.getBackgrounds()),
  ...
  setData(data: Background[]): void {
    this.dataSource = new MatTableDataSource(data);
    this.paginator._intl.itemsPerPageLabel = 'Предысторий на страницу';
