  ...
  addCharacter(): void {
    this._dialog
      .open(SimpleDialogComponent, {
        data: {
          title: 'Инструкция',
          text: 'Вы начали создание своего персонажа 1 уровня. Создание происходит в 3 этапа. Переключаться между этапами можно используя кнопки навигации в верхнем тулбаре.',
        },
      })
      .afterClosed()
      .subscribe((res) => {
